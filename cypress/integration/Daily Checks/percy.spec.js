      ...
      */
          ...
          it('Services page compare', () => {
           ...
           cy.xpath('/html/body/div[3]/div/div/div/div[3]/div[2]/button').should('be.visible').click()
           cy.wait(6000)
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[1]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[2]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[3]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[4]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[5]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[6]/div/div/div[2]/div/picture/img').should('be.visible')
           cy.xpath('/html/body/div[1]/div[1]/div/div/main/article/section[7]/div/div/div[2]/div/picture/img').should('be.visible')
            // Take a snapshot for visual diffing
